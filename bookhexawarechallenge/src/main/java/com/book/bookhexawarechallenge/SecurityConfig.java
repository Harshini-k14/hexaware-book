package com.book.bookhexawarechallenge;
     ...
     SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/book/update/{id}").hasRole("ADMIN")
                        .requestMatchers("/book/all").hasRole("ADMIN")

                        .requestMatchers("/book/{isbn}").hasRole("ADMIN")
